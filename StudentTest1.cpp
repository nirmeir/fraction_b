...
TEST_CASE("Fraction object initialization & Getters return expected values") {
    ...
    // cout <<"####### FRACTION"<< b.getNumerator() << "/" << b.getDenominator() << endl;
...
TEST_CASE("Fraction addition test") {
    ...
    cout<<"####### FRACTION"<< c.getNumerator() << "/" << c.getDenominator() << endl;
    ...
    cout<<"####### FRACTION F"<< f.getNumerator() << "/" << f.getDenominator() << endl;
    CHECK(((f.getNumerator() == 3) && (f.getDenominator() == 5)));
    CHECK(__gcd(f.getNumerator(), f.getDenominator()) == 1);

    Fraction g = e + d;

    cout<<"####### FRACTION G"<< g.getNumerator() << "/" << g.getDenominator() << endl;
...
TEST_CASE("Fraction subtraction test") {
    ...
    cout<<"####### FRACTION C"<< c.getNumerator() << "/" << c.getDenominator() << endl;
